# Environment Setup for Clothify (local development)

## Required Environment Variables

To run the Clothify application locally, set the following environment variables in your `.env.local` file:

1. **MONGODB_URI**: The connection string for your MongoDB database.
   - Example: `MONGODB_URI=mongodb://127.0.0.1:27017/clothify`
